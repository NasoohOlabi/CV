...
\personalinfo{%
   ...
   \location{New Cham sec 16, Damascus}
...
\begin{paracol}{2}
   ...
   \cvevent{Software Developer}{Maids.cc}{June 2022 -- Present}{}
   ...
   \cvevent{M.Sc in Big Data Analytics}{Higher Institute of Applied Sciences and Technology (HIAST)}{October 2024 -- On going...}{}
   \cvevent{B.Sc in Software Engineering \& Artificial Intelligence}{Higher Institute of Applied Sciences and Technology (HIAST)}{October 2018 -- 2023}{}

   \cvsection{Proud of}

   \cvachievement{\faProjectDiagram}{Stegasus}{
      Text based Steganography Engine Using a multi phase encoding.
   }

   \cvachievement{\faProjectDiagram}{meScheduler}{My first project which helped me learn at first hand about tackling a real world problem using Search Algorithms in a Typescript-React PWA utilizing Webworkers.}
